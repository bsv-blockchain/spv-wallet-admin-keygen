...
<table align="center" border="0">
  ...
  <tr>
    ...
    <td align="left">
       ...
       <a href="https://deepwiki.com/bsv-blockchain/spv-wallet-admin-keygen"><img src="https://deepwiki.com/badge.svg" alt="Ask DeepWiki"></a>
    </td>
  </tr>
</table>
...
All unit tests and examples run via [GitHub Actions](https://github.com/bsv-blockchain/spv-wallet-admin-keygen/actions) and use [Go version 1.26.x](https://go.dev/doc/go1.26). View the [configuration file](.github/workflows/fortress.yml).
